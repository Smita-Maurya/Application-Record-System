const sampleListings = [
  {
    company: "Cozy Beachfront Cottage",
    description:
  ...
  {
    company: "Modern Loft in Downtown",
    description:
  ...
  {
    company: "Historic Villa in Tuscany",
    description:
  ...
  {
    company: "Secluded Treehouse Getaway",
    description:
  ...
  {
    company: "Rustic Cabin by the Lake",
    description:
  ...
  {
    company: "Luxury Penthouse with City Views",
    description:
  ...
  {
    company: "Safari Lodge in the Serengeti",
    description:
  ...
  // },
  // {
  //   company: "Private Island Retreat",
  //   description:
  ...
  // },
  // {
  //   company: "Charming Cottage in the Cotswolds",
  //   description:
  ...
  // },
  // {
  //   company: "Historic Brownstone in Boston",
  //   description:
...
// sampleListings.sort(function(a, b) {
...
// });
//<script>
//const sortedElements = elements.slice().sort();
//</script>
//module.exports = { data: sortedElements  };
